...
const labelsMap = {
  ...
  hitBlock: "Block hit",
  enterPipeDown: "Enter pipe down",
  enterPipeUp: "Enter pipe up",
  enterPipeRight: "Enter pipe right",
  enterPipeLeft: "Enter pipe left",
  fellInPit: "Fell in pit",
};
...
const valuesMap = {
  ...
  hitBlock: "HIT_BLOCK",
  enterPipeDown: "ENTER_DOWN_PIPE",
  enterPipeUp: "ENTER_UP_PIPE",
  enterPipeRight: "ENTER_RIGHT_PIPE",
  enterPipeLeft: "ENTER_LEFT_PIPE",
  fellInPit: "FELL_IN_PIT",
};
